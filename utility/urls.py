...
view_notification,show_distribution, print_request,get_stats, fund_details_departments)
...
urlpatterns = [
    ...
    path('department/fund',fund_details_departments, name='department_funds'),
    path('department/fund/<str:deptId>',fund_details_departments,name="stats"),
